...
\definecolor{myLightBlue}{HTML}{0095FF} %00B3FF
...
%\colorlet{myGreen}{LimeGreen!50!OliveGreen}
\colorlet{myGray}{gray!80!white}
...
\newcommand{\intro}[1]{{\color{orange}#1}} % \intro{<text>}, makes <text> orange, use to highlight things to do, urgent, or revisit in introduction section
\newcommand{\ahc}[1]{{\color{myLightBlue}#1}} % \ahc{<text>}, makes <text> blue, use to highlight things to do, urgent, or revisit in AHC section
\newcommand{\scspp}[1]{{\color{Rhodamine}#1}} % \scspp{<text>}, makes <text> pink, use to highlight things to do, urgent, or revisit in SCSPP section
\newcommand{\ea}[1]{{\color{OrangeRed}#1}} % \ea{<text>}, makes <text> red, use to highlight things to do, urgent, or revisit in EA section
\newcommand{\postopt}[1]{{\color{myGreen}#1}} % \postopt{<text>}, makes <text> green, use to highlight things to do, urgent, or revisit in Postoptimisation section
\newcommand{\note}[1]{{\color{Orchid}#1}} % \note{<text>}, makes <text> purple, use to highlight things to do, urgent, or revisit in any section
