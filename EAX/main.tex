...
\begin{figure}[H]
	...
	\begin{subfigure}[h]{0.42\textwidth}
		\includestandalone[width=\textwidth]{figures/bppnew}
		\caption{BPP}
		\label{fig:bpp}
	\end{subfigure} \hspace{10mm}
	\begin{subfigure}[h]{0.42\textwidth}
		\includestandalone[width=\textwidth]{figures/scppnew}
		\caption{SCPP}
		\label{fig:scpp}
	\end{subfigure}
