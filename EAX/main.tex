...
\begin{tabular}{c@{\hspace{20pt}}c@{\hspace{20pt}}ccc@{\hspace{15pt}}c@{\hspace{10pt}}cc@{\hspace{15pt}}c@{\hspace{10pt}}cc@{\hspace{15pt}}c@{\hspace{10pt}}}\toprule
	...
	real, 100 & 5000 & 11.981 && - & - && 17.621 & 466 && 17.608 & 466 \\
	\midrule
	real, 500 & 2500 & 115.239 && 134.342 & 45 && 134.586 & 55 && - & - \\
	real, 500 & 5000 & 57.865 && - & - && - & - && - & - \\
	\midrule
...
\noindent The exact cover problem, determining whether a subcollection $\mathcal{S}^*$ exists, is a decision problem, and one of Karp's 21 NP-complete problems \citet{karp1972}. However, if we know that an exact cover does indeed exist, we can alter the problem to instead find the smallest subcollection.
...
\begin{algorithmic}[1]
	\State $\mathcal{S}_{bsf} \gets \emptyset$, $\mathcal{C}^* \gets \emptyset$
