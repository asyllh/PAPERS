...
\begin{table}[h!]
\centering
\caption{\ea{Results obtained from EA using different recombination operators. Figures in bold indicate the best results for each instance type. NEED TO UPDATE NSR1021 AND NSR1022.}}
\small
\begin{threeparttable}
\begin{tabular}{crrrrcrrcrrcrr}
	...
	\midrule
	\midrule
	r, 2500 & 100 & 23.47 & 25.99 & \textbf{573} && 26.07 & 570 && \textbf{25.95} & 570 && 35.42 & 16\\
	& 500 & 115.24 & \textbf{133.94} & 47 && 134.25 & \textbf{59} && 133.99 & 41 && 177.25 & 0\\
	& 1000 & 229.95 & 270.40 & 1 && 270.65 & \textbf{2} && \textbf{270.03} & 1 && 355.04 & 0\\
	\midrule
	r, 5000 & 100 & 11.98 & \textbf{17.51} & \textbf{480} && 17.54 & 468 && 17.54 & 462 && 29.61 & 5\\
	& 500 & 57.87 & \textbf{93.59} & \textbf{87} && 94.18 & 86 && 93.97 & 80 && 153.42 & 0\\
	& 1000 & 115.23 & \textbf{192.38} & \textbf{31} && 192.92 & 26 && 192.79 & 30 && 308.64 & 0\\
	\bottomrule
\end{tabular}	
\vspace{0.2cm} %
\begin{tablenotes}
