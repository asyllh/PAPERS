...
\caption{\cmsa{CMSA}}
\begin{threeparttable}
\begin{tabular}{lrrcrrcrrrr}
	\toprule
	& & & & \multicolumn{2}{c}{EA} &\phantom{ab}& \multicolumn{4}{c}{CMSA}\\
	\cmidrule{5-6} \cmidrule{8-11}
	\multicolumn{1}{c}{Type, $W$} & \multicolumn{1}{c}{$n$} & \multicolumn{1}{c}{$t$\tnote{$a$}} && \multicolumn{1}{c}{$|\mathcal{S}|$\tnote{$b$}} & \multicolumn{1}{c}{$\# t$\tnote{$c$}} && \multicolumn{1}{c}{$|\mathcal{S}|$} & \multicolumn{1}{c}{$\# t$} & \multicolumn{1}{c}{$=$} & \multicolumn{1}{c}{$<$}\\
	\midrule
	a, $W=2500$ & 100 & 23.323 && 23.38 & 49 && 24.02 & 21 & 22 & 0 \\
	& 500 & 114.942 && 116.1 & 17 && 118.48 & 0 & 5 & 0 \\
	& 1000 & 229.437 && 234.84 & 0 && 237.1 & 0 & 8 & 4 \\
	\midrule
	a, $W=5000$ & 100 & 11.922 && 12.56 & 39 && 13.54 & 24 & 24 & 0 \\
	& 500 & 57.722 && 61.9 & 1 && 75.6 & 0 & 0 & 0 \\
	& 1000 & 114.965 && 126.4 & 0 && 169.04 & 0 & 0 & 0 \\
	\midrule
	\midrule
	r, $W=2500$ & 100 & 23.473 && 27.52 & 21 && 27.94 & 15 & 28 & 6 \\
	& 500 & 115.239 && 143.1 & 4 && 148.08 & 0 & 7 & 9 \\
	& 1000 & 229.946 && 290.32 & 0 && 294.76 & 0 & 5 & 23 \\
	\midrule
	r, $W=5000$ & 100 & 11.981 && 20.56 & 16 && 20.98 & 12 & 27 & 5 \\
	& 500 & 57.865 && 109.28 & 4 && 114.18 & 6 & 5 & 16 \\
	& 1000 & 115.227 && 224.52 & 0 && 239.38 & 0 & 4 & 15 \\
	\bottomrule
\end{tabular}
\vspace{0.2cm} %
\begin{tablenotes}
...
\begin{itemize}[leftmargin=*]
	...
	\item CMSA using 50 instances, comparing with results from EA (with the best results obtained from EA of the three recombination operators).
	\item Parameters, $p = 3, maxAge = 3$ after preliminary tests.
	\item CMSA time limit 3600 seconds, exact cover algorithm time limit 600 seconds.
