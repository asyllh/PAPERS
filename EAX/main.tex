...
\begin{itemize}[leftmargin=*]
	\item CMSA does not perform as well as EA.
	...
	\item CMSA has higher CV in all artificial instance classes, lower for real instance classes, smaller than the EA in four of the six real instance classes.
	\item CMSA unable to find a solution comprising $t$ bins for any of the 50 instances in all instance classes using 1000 items, however the EA is also unable to find a solution comprising $t$ bins for any of the 50 instances for three of the instance classes using 1000 items (suggests that the optimal solution may not comprise $t$ bins).
	\item CMSA unable to find solution using the same number of bins as solutions found by EA for any of the 50 instances for A55 and A105.
	...
	\item CMSA performs fewer iterations than EA on average for 9 of the instance classes.
	\item
