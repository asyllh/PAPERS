...
\begin{subequations}
	...
	S_i \cap S_j &= \emptyset \hspace{5.6mm} \forall \hspace{1mm} i, j \in \{1, 2,\dotsc,k\}, \hspace{2mm} i \neq j, \label{eqn:nointersect} \\[3pt]
	S_i &\in \mathcal{F} \hspace{5mm} \forall \hspace{1mm} i\in \{1,2,\dotsc,k\}.\label{eqn:feasible}
	\end{align}
\end{subequations}
