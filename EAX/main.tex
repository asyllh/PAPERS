...
\begin{figure}[H]	
	...
	\begin{subfigure}[h]{0.33\textwidth}
		...
		\label{fig:mffdplus}
	\end{subfigure}
	\caption{\heur{Solutions using MFFD and MFFD$^+$ for the same instance of the SCPP.}}
...
\begin{algorithm}
\caption{\textsc{Construct, Merge, Solve \& Adapt} ($\mathcal{I}$, $p$, $maxAge$)}
\begin{algorithmic}[1]
