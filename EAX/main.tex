...
3a. Heuristics - sub:heuristics
3b. Experimental Results - Heuristics - sub:expheuristics
4. EA - sec:ea
4a. Mutation - sub:mutation
4b. Crossover Operators - sub:xover
4c. Local Search - sub:localsearch
4d. EA Process - sub:eaframework
4e. Experimental Results - EA - sub:expea
5. Postoptimisation - sec:postopt
5a. Experimental Results - Postoptimisation - sub:exppostopt
