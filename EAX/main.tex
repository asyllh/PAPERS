...
\begin{abstract}
\note{Type of packing problem in which order and orientation of items is important. Paper investigates heuristics, EA, postoptimisation.} \alert{make sure it says ``vicinal sum constraint'', not ``vicinal score constraint'', make sure all primes are $'$ not '.}
\end{abstract}	
\end{frontmatter}
