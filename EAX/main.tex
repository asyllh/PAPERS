...
\begin{itemize}[leftmargin=*]
	...
	\item Lowerbound cite Martello \cite{martello1990l}.
	...
	\item Our implementation of AHC in MFFD$^+$ has the preliminary check, previous paper does not.
