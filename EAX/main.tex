...
\begin{itemize}
	...
	\item Every time AHC is called, if a solution is found, this is stored in a feasible packings set, else if no solution found, items stored in an infeasible packings set.
...
\begin{table}[h!]
	...
	\begin{tabular}{cccccccccccc}\toprule
		...
		a,100 & 2500 & 23.323 && 23.483 & 931 && 23.357 & 977 && EA123 & -\\
