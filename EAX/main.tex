...
\label{sec:ahc}
In this section, we focus on the SubSCP, which involves packing items into a single bin. To begin, let us first consider the following sequencing problem originally defined by \cite{hawa2018}:
