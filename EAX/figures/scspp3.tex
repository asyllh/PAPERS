...
% item i
\draw [thick] (-5,0.95) rectangle (-2,2.3);
\draw [thick, dashed] (-4.6,0.95) -- (-4.6, 2.3);
\draw [thick, dashed] (-2.6,0.95) -- (-2.6, 2.3);
\node at (-3.5,1.625) {\LARGE{$i$}};

%arrow and label for width w_i
\draw [<->] (-5,0.75) -- (-2,0.75);
\node at (-3.5, 0.45) {\Large{$w_i$}};

%arrow and label for score width a_i
\draw [<->] (-5, 2.45) -- (-4.6, 2.45);
\node at (-4.8, 2.7) {\Large{$a_i$}};

%arrow and label for score width b_i
\draw [<->] (-2.6, 2.45) -- (-2, 2.45);
\node at (-2.3, 2.7) {\Large{$b_i$}};

%arrow and label for height H
\draw [<->] (-1.8,0.95) -- (-1.8,2.3);
\node at (-1.5,1.625) {\Large{$H$}};
