...
\node [above] at (2,3.05) {\large{$v_{12}$}};
\node [above] at (3,3.05) {\large{$v_5$}};
\node [above] at (4,3.05) {\large{$v_8$}};
\node [above] at (5,3.05) {\large{$v_7$}};
\node [above] at (6,3.05) {\large{$v_{10}$}};
\node [above] at (7,3.05) {\large{$v_4$}};
\node [above] at (8,3.05) {\large{$v_6$}};
\node [above] at (9,3.05) {\large{$v_9$}};
\node [above] at (10,3.05) {\large{$v_{11}$}};
\node [above] at (11,3.05) {\large{$v_3$}};
\node [above] at (12,3.05) {\large{$v_1$}};

\node at (1,2.5) {\large{1}};
\node at (2,2.5) {\large{6}};
\node at (3,2.5) {\large{2}};
\node at (4,2.5) {\large{4}};
\node at (5,2.5) {\large{3}};
\node at (6,2.5) {\large{5}};
\node at (7,2.5) {\large{2}};
\node at (8,2.5) {\large{3}};
\node at (9,2.5) {\large{4}};
\node at (10,2.5) {\large{5}};
\node at (11,2.5) {\large{2}};
