...
\begin{tikzpicture}
\draw [help lines] (-1,-2) grid (10,10);
% 1=0.1, 2=0.15, 3=0.2, 4=0.25, 5=0.3
% A1 = 3.5, B2 = 3, C3 = 2.75, D4 = 2.25, E5 = 2, F6 = 1.75, G7 = 1.25
...
\draw [thick] (0,5) rectangle (7.5,5.75);
\draw [thick] (0,6.25) rectangle (7.5,7);
\draw [thick] (0,7.5) rectangle (7.5,8.25);
