...
\node at (2,5.3) {\small{$|R^*_1| = z$}};

\draw [thick, tRed] (1,3) -- (1,4);
\draw [thick, tRed] (2,3) -- (2,4);
\draw [thick, tRed] (3,3) -- (3,4);

\draw [thick, densely dashed, tRed] (1,4) -- (2,3);
\draw [thick, densely dashed, tRed] (2,4) -- (3,3);
\draw [thick, densely dashed, tRed] (3,4) to[out=120,in=130, distance=2.2cm] (1,3);
...
\draw [thick, tRed] (5,3) -- (5,4);
\draw [thick, tRed] (6,3) -- (6,4);
