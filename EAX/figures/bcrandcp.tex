...
\draw [thick] (2.7,6.35) -- (5.3,6.35);
\draw [thick] (2.7,6.34) -- (2.7,6.65);
\draw [thick] (5.3,6.34) -- (5.3,6.65);
\node at (4,6) {\small{$R^*_1$}};
%\node at (1,6.1) {$C_1$};
%\node at (2,6.1) {$C_1$};
%\node at (3,6.1) {$C_1$};
%\node at (4,6.1) {$C_2$};
...
%\node at (0.25,8) {\large{$\mathcal{L}$}};

%----------------------------------------------------------------
% EDGES IN SET R1 WITH EDGES FROM R\R' DASHED, CONNECTING PROCEDURE.
\node at (2,5.3) {\small{$\mathcal{R}^* = \{R^*_1\}$}};

\draw [thick, tRed] (1,3) -- (1,4);
\draw [thick, tRed] (2,3) -- (2,4);
\draw [thick, tRed] (3,3) -- (3,4);

\draw [thick, densely dashed, tGreen] (1,4) -- (2,3);
\draw [thick, densely dashed, tGreen] (2,4) -- (3,3);
\draw [thick, densely dashed, tGreen] (3,4) to[out=120,in=130, distance=2.2cm] (1,3);
...
\draw [thick] (3.7,3.45) -- (4.1,3.45);
\draw [thick] (3.7,3.55) -- (4.1,3.55);
\draw [thick] (4.3,3.495) -- (4.1,3.65);
\draw [thick] (4.3,3.505) -- (4.1,3.35);
\draw [thick] (4.1,3.65) -- (4.1,3.545);
\draw [thick] (4.1,3.35) -- (4.1,3.455);
\draw [thick] (3.705,3.45) -- (3.705,3.55);

%-------------------------------------------
% EDGES FROM R\R' FOUND USING BCR AND CONNECTING PROCEDURE, USE TO CONNECT CYCLES.
\node at (6,5.3) {\small{Bridges from $R\backslash R'$}};

\draw [thick, densely dashed, tGreen] (5,3) -- (5,4);
\draw [thick, densely dashed, tGreen] (6,3) -- (6,4);
\draw [thick, densely dashed, tGreen] (7,3) -- (7,4);
