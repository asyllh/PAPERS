...
\draw [ultra thick, densely dashed, tGreen] (5.5,3) -- (5.5,5);
\draw [ultra thick, densely dashed, tGreen] (4,3) -- (5.5,1);
\draw [ultra thick, loosely dotted, tOrange] (8,7) -- (9.5,5);
\draw [ultra thick, loosely dotted, tOrange] (8,1) -- (9.5,3);
\draw [ultra thick, loosely dotted, tOrange] (8,3) -- (8,5);
...
\node [below] at (5.5,3) {$v_{16}$};
\node [below] at (8,3) {$v_{12}$};
