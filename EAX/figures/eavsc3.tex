...
%Parent 2 BEFORE
\node at (2.5,3.75) {\Large{$\mathcal{S}_2$}};
...
%bottom row, 4, 4 (1-5, 3-1)
\draw [thick] (8.5,5) -- (8.5,5.75);
\draw [thick] (10.5,5) -- (10.5,5.75);
\filldraw[fill=black!20!white, draw=black, thick] (10.5,5) rectangle (11.5,5.75);
\draw [thick, dashed] (6.6,5) -- (6.6,5.75);
\draw [thick, dashed] (8.2,5) -- (8.2,5.75);
\draw [thick, dashed] (8.7,5) -- (8.7,5.75);
\draw [thick, dashed] (10.4,5) -- (10.4,5.75);
\node [below] at (6.6,5) {\scriptsize{1}};
\node [below] at (8.2,5) {\scriptsize{5}};
\node [below] at (8.7,5) {\scriptsize{3}};
\node [below] at (10.4,5) {\scriptsize{1}};
\node at (7.5,5.375) {4};
\node at (9.5,5.375) {4};

%middle row, 5, 2, 2 (1-2, 5-4, 4-2)
\draw [thick] (9,6.25) -- (9,7);
\draw [thick] (10,6.25) -- (10,7);
...
\draw [thick, dashed] (8.85,6.25) -- (8.85,7);
\draw [thick, dashed] (9.3,6.25) -- (9.3,7);
\draw [thick, dashed] (9.75,6.25) -- (9.75,7);
\draw [thick, dashed] (10.25,6.25) -- (10.25,7);
\draw [thick, dashed] (10.85,6.25) -- (10.85,7);
\node [below] at (6.6,6.25) {\scriptsize{1}};
\node [below] at (8.85,6.25) {\scriptsize{2}};
\node [below] at (9.3,6.25) {\scriptsize{5}};
\node [below] at (9.75,6.25) {\scriptsize{4}};
\node [below] at (10.25,6.25) {\scriptsize{4}};
\node [below] at (10.85,6.25) {\scriptsize{2}};
\node at (7.75,6.625) {5};
\node at (9.5,6.625) {2};
\node at (10.5,6.625) {2};
...
\draw [thick] (9.5,7.5) -- (9.5,8.25);
\filldraw[fill=black!20!white, draw=black, thick] (9.5,7.5) rectangle (11.5,8.25);
\draw [thick, dashed] (6.65,7.5) -- (6.65,8.25);
\draw [thick, dashed, tRed] (7.8,7.5) -- (7.8,8.25);
\draw [thick, dashed, tRed] (8.2,7.5) -- (8.2,8.25);
\draw [thick, dashed] (9.4,7.5) -- (9.4,8.25);
\node [below] at (6.65,7.5) {\scriptsize{2}};
\node [below] at (7.8,7.5) {\textcolor{tRed}{\scriptsize{3}}};
\node [below] at (8.2,7.5) {\textcolor{tRed}{\scriptsize{3}}};
\node [below] at (9.4,7.5) {\scriptsize{1}};
\node at (7.25,7.875) {3};
\node at (8.75,7.875) {3};
...
%---------------------------------------------
% OFFSPRING
\node at (15.5,5) {\Large{$\mathcal{S}$}};

% items 5, 2, 3 (1-2, 5-4, 4-4)
\draw [thick] (13,3.75) rectangle (18,4.5);
\draw [thick] (15.5,3.75) -- (15.5,4.5);
\draw [thick] (16.5,3.75) -- (16.5,4.5);

\draw [thick, dashed] (13.1,3.75) -- (13.1,4.5);
\draw [thick, dashed] (15.35, 3.75) -- (15.35,4.5);
\draw [thick, dashed] (15.8,3.75) -- (15.8,4.5);
\draw [thick, dashed] (16.25,3.75) -- (16.25,4.5);
\draw [thick, dashed] (16.75, 3.75) -- (16.75,4.5);
\draw [thick, dashed] (17.75,3.75) -- (17.75,4.5);
\node [below] at (13.1,3.75) {\scriptsize{1}};
\node [below] at (15.35,3.75) {\scriptsize{2}};
\node [below] at (15.8,3.75) {\scriptsize{5}};
\node [below] at (16.25,3.75) {\scriptsize{4}};
\node [below] at (16.75,3.75) {\scriptsize{4}};
\node [below] at (17.75,3.75) {\scriptsize{4}};

\node at (14.25,4.125) {5};
\node at (16,4.125) {2};
\node at (17.25,4.125) {3};
