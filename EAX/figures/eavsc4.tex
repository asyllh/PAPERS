...
\begin{tikzpicture}
%\draw [help lines] (-1,-2) grid (25,10);
...
%bottom row, 4, 4 (1-5, 3-1) -p1before
...
%bottom row, 4, 4 (1-5, 3-1) -p1after
...
\draw [thick, dashed] (10.2,5) -- (10.2,4.25);
\draw [thick, dashed] (10.7,5) -- (10.7,4.25);
\draw [thick, dashed] (12.4,5) -- (12.4,4.25);
\node [below] at (8.6,4.25) {\scriptsize{1}};
\node [below] at (10.2,4.25) {\scriptsize{5}};
\node [below] at (10.7,4.25) {\scriptsize{3}};
