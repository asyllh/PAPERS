...
\draw [semithick] (5.7,6.65) -- (5.7,6.35) -- (8.3,6.35) -- (8.3,6.65);
%\node at (3,6.1) {\small{$R^*_1$}}; % R^*
%\node at (7,6.1) {\small{$R^*_2$}}; % R^*

\node at (3,6.1) {\small{$R''_1$}}; % R''
\node at (7,6.1) {\small{$R''_2$}}; % R''

%\node at (5,5.3) {\small{$\mathcal{R}^* = \{R^*_1, R^*_2\}$}};

%\node [right] at (3.55,5.5) {\small{$R^*_1: C_1, C_2, C_3$}}; % R^*
%\node [right] at (3.55,5.1) {\small{$R^*_2:$}}; % R^*

%\node [right] at (3.55,5.5) {\small{$R''_1: C_1, C_2, C_3$}}; % R''
%\node [right] at (3.55,5.1) {\small{$R''_2:$}}; % R''
%\node [right] at (4.77,5.1) {\small{$C_2, C_3, C_4$}};
%\draw [semithick, tRed] (4.85, 5) -- (4.85, 4.9) -- (5.9, 4.9) -- (5.9, 5);
%\draw [tRed] (4.85, 4.9) rectangle (5.8, 5.725);

\node [right] at (3.55,5.5) {\small{$R''_1: C_1\text{ }C_2\text{ }C_3$}}; % R''
\node [right] at (3.55,5.05) {\small{$R''_2:$}}; % R''
%\node [right] at (4.725,5.05) {\small{$C_2\text{ }C_3\text{ }C_4$}};
\node [right] at (4.83,5.05) {\small{$C_2\text{ }C_3\text{ }C_4$}};
%\draw [semithick, tRed] (4.8, 5) -- (4.8, 4.85) -- (5.75, 4.85) -- (5.75, 5);
\draw [semithick, tRed] (4.91, 5) -- (4.91, 4.85) -- (5.92, 4.85) -- (5.92, 5);
%\draw [tRed] (4.8, 4.85) rectangle (5.75, 5.725);
...
%-------------------------------------------
% R2
\draw (6.95,5.6) -- (6.95, 5.2) -- (6.85,5.2) -- (7,5) -- (7.15,5.2) -- (7.05,5.2) -- (7.05,5.6) -- (6.95,5.6);
\draw [thick, tRed] (6,2.75) -- (6,3.75);
\draw [thick, tRed] (7,2.75) -- (7,3.75);
\draw [thick, tRed] (8,2.75) -- (8,3.75);

\draw [very thick, dotted, tOrange] (6,3.75) -- (7,2.75);
\draw [very thick, dotted, tOrange] (7,3.75) -- (8,2.75);
\draw [very thick, dotted, tOrange] (8,3.75) to[out=125,in=130, distance=2.2cm] (6,2.75);

\draw [fill=white, thick] (6,2.75) circle [radius = 0.08];
\draw [fill=white, thick] (7,2.75) circle [radius = 0.08];
\draw [fill=white, thick] (8,2.75) circle [radius = 0.08];
\draw [fill=white, thick] (6,3.75) circle [radius = 0.08];
\draw [fill=white, thick] (7,3.75) circle [radius = 0.08];
\draw [fill=white, thick] (8,3.75) circle [radius = 0.08];

\node at (6,2.45) {\large{$v_{13}$}};
\node at (7,2.45) {\large{$v_{12}$}};
\node at (8,2.45) {\large{$v_{11}$}};
\node at (6,4.05) {\large{$v_6$}};
...
\node at (6,-0.3) {\large{$v_{12}$}};
\node at (7,-0.3) {\large{$v_{11}$}};
\node at (8,-0.3) {\large{$v_{13}$}};
