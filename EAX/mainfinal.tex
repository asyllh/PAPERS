...
%\chng{We also explore an alternative approach based on a Construct, Merge, Solve $\&$ Adapt procedure, and discuss the circumstances in which each approach proves most advantageous.}
\end{abstract}
...
%\chng{An alternative to the EA based on the Construct, Merge, Solve $\&$ Adapt (CMSA) algorithm is then considered in Section~\ref{sec:cmsa}.}
