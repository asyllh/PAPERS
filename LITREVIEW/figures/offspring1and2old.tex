...
\path [fill=tLightBlue] (13,7.5) rectangle (18.47,8.5);
\path [fill=tLightPink] (18.47,7.5) rectangle (22.06,8.5);
\draw [thick] (13,7.5) rectangle (23, 8.5);
\draw [thick] (15.11,7.5) -- (15.11, 8.5);
\draw [thick] (18.47,7.5) -- (18.47, 8.5); % E FROM OTHER PARENT
\draw [thick] (22.06,7.5) -- (22.06, 8.5);
\filldraw[fill=black!20!white, draw=black, thick] (22.06,7.5) rectangle (23,8.5);
\draw [densely dashed] (13.23,7.5) -- (13.23,8.5);
\draw [densely dashed] (14.78,7.5) -- (14.78,8.5);
\draw [densely dashed] (15.54,7.5) -- (15.54,8.5);
\draw [densely dashed] (18.00,7.5) -- (18.00,8.5);
\draw [densely dashed] (18.84,7.5) -- (18.84,8.5);
\draw [densely dashed] (21.8,7.5) -- (21.8,8.5);
\node at (14.055,7.8) {$211$};
\node at (16.79,7.8) {$336$};
\node at (20.265,7.8) {$359$};
\node at (14.055,8.2) {\large K};
\node at (16.79,8.2) {\large F};
\node at (20.265,8.2) {\large E}; 
\node [below] at (13.23,7.5) {\small$23$};
\node [below] at (14.78,7.5) {\small$33$};
\node [below] at (15.54,7.5) {\small$43$};
\node [below] at (18.00,7.5) {\small$47$};
\node [below] at (18.84,7.5) {\small$37$};
\node [below] at (21.8,7.5) {\small$26$};

% M, B, 200, 615 (14-18, 54-4)
\path [fill=tLightBlue] (13,6) rectangle (21.15,7);
\draw [thick] (13,6) rectangle (23, 7);
\draw [thick] (15,6) -- (15,7);
\filldraw[fill=black!20!white, draw=black, thick] (21.15,6) rectangle (23,7);
\draw [densely dashed] (13.14,6) -- (13.14,7);
\draw [densely dashed] (14.82,6) -- (14.82,7);
\draw [densely dashed] (15.54,6) -- (15.54,7);
\draw [densely dashed] (21.1,6) -- (21.1,7);
\node at (14,6.3) {$200$};
\node at (18.075,6.3) {$615$};
\node at (14,6.7) {\large M};
\node at (18.075,6.7) {\large B};
\node [below] at (13.14,6) {\small$14$};
\node [below] at (14.82,6) {\small$18$};
\node [below] at (15.54,6) {\small$54$};
\node [below] at (21.1,6) {\small$4$};


% A, C, L, 631, 561, 207 (48-68, 48-63, 69-48) (OVERFULL) C FROM OTHER PARENT
\path [fill=tLightBlue] (13,4.5) rectangle (19.31,5.5);
\path [fill=tLightPink] (19.31,4.5) rectangle (24.92,5.5);
\path [fill=tLightBlue] (24.92,4.5) rectangle (26.99,5.5);
\draw [thick] (13,4.5) rectangle (26.99, 5.5);
\draw [thick] (19.31,4.5) -- (19.31,5.5);
\draw [thick] (24.92,4.5) -- (24.92,5.5); % C FROM OTHER PARENT
\draw [thick] (26.99,4.5) -- (26.99,5.5);
%\filldraw[fill=black!20!white, draw=black, thick] (9.88,4.5) rectangle (10,5.5);
\draw [densely dashed] (13.48,4.5) -- (13.48,5.5);
\draw [densely dashed] (18.63,4.5) -- (18.63,5.5);
\draw [densely dashed] (19.79,4.5) -- (19.79,5.5);
\draw [densely dashed] (24.29,4.5) -- (24.29,5.5);
\draw [densely dashed] (25.61,4.5) -- (25.61,5.5);
\draw [densely dashed] (26.51,4.5) -- (26.51,5.5);
\node at (16.155,4.8) {$631$};
\node at (22.115,4.8) {$561$};
\node at (25.955,4.8) {$207$};
\node at (16.155,5.2) {\large A};
\node at (22.115,5.2) {\large C};
\node at (25.955,5.2) {\large L};
\node [below] at (13.48,4.5) {\small$48$};
\node [below] at (18.63,4.5) {\small$68$};
\node [below] at (19.79,4.5) {\small$48$};
\node [below] at (24.29,4.5) {\small$63$};
\node [below] at (25.61,4.5) {\small$69$};
\node [below] at (26.51,4.5) {\small$48$};

% G, H, 328, 327 (16-31, 44-17) H FROM OTHER PARENT
\path [fill=tLightBlue] (13,3) rectangle (16.28,4);
\path [fill=tLightPink] (16.28,3) rectangle (19.55,4);
\draw [thick] (13,3) rectangle (23,4);
\draw [thick] (16.28,3) -- (16.28,4);
\draw [thick] (19.55,3) -- (19.55,4); % H FROM OTHER PARENT
\filldraw[fill=black!20!white, draw=black, thick] (19.55,3) rectangle (23,4);
\draw [densely dashed] (13.16,3) -- (13.16,4);
\draw [densely dashed] (15.97,3) -- (15.97,4);
\draw [densely dashed] (16.72,3) -- (16.72,4);
\draw [densely dashed] (19.38,3) -- (19.38,4);
\node at (14.64,3.3) {$328$};
\node at (17.915,3.3) {$327$};
\node at (14.64,3.7) {\large G};
\node at (17.915,3.7) {\large H};
\node [below] at (13.16,3) {\small$16$};
\node [below] at (15.97,3) {\small$31$};
\node [below] at (16.72,3) {\small$44$};
\node [below] at (19.38,3) {\small$17$};


% J, N, I, 305, 192, 321 (12-51, 22-68, 47-13)
\path [fill=tLightBlue] (13,1.5) rectangle (21.18,2.5);
\draw [thick] (13,1.5) rectangle (23, 2.5);
\draw [thick] (16.05,1.5) -- (16.05,2.5);
\draw [thick] (17.97,1.5) -- (17.97,2.5);
\filldraw[fill=black!20!white, draw=black, thick] (21.18,1.5) rectangle (23,2.5);
\draw [densely dashed] (13.12,1.5) -- (13.12,2.5);
\draw [densely dashed] (15.54,1.5) -- (15.54,2.5);
\draw [densely dashed] (16.27,1.5) -- (16.27,2.5);
\draw [densely dashed] (17.29,1.5) -- (17.29,2.5);
\draw [densely dashed] (18.44,1.5) -- (18.44,2.5);
\draw [densely dashed] (21.05,1.5) -- (21.05,2.5);
\node at (14.525,1.8) {$305$};
\node at (17.01,1.8) {$192$};
\node at (19.575,1.8) {$321$};
\node at (14.525,2.2) {\large J};
\node at (17.01,2.2) {\large N};
\node at (19.575,2.2) {\large I};
\node [below] at (13.12,1.5) {\small$12$};
\node [below] at (15.54,1.5) {\small$51$};
\node [below] at (16.27,1.5) {\small$22$};
\node [below] at (17.29,1.5) {\small$68$};
\node [below] at (18.44,1.5) {\small$47$};
\node [below] at (21.05,1.5) {\small$13$};


% O, D 150, 525 (8-22 X 42-3) (VSC NOT MET) O FROM OTHER PARENT
\path [fill=tLightPink] (13,0) rectangle (14.5,1);
\path [fill=tLightBlue] (14.5,0) rectangle (19.75,1);
\draw [thick] (13,0) rectangle (23,1); 
\draw [thick] (14.5,0) -- (14.5,1);% O FROM OTHER PARENT
\draw [thick] (19.75,0) -- (19.75,1);
\filldraw[fill=black!20!white, draw=black, thick] (19.75,0) rectangle (23,1);
\draw [densely dashed] (13.08,0) -- (13.08,1);
\draw [densely dashed, tRed] (14.28,0) -- (14.28,1);
\draw [densely dashed, tRed] (14.92,0) -- (14.92,1);
\draw [densely dashed] (19.70,0) -- (19.70,1);
\node at (13.75,0.3) {$150$};
\node at (17.125,0.3) {$525$};
\node at (13.75,0.7) {\large O};
\node at (17.125,0.7) {\large D};
\node [below] at (13.04,0) {\small$8$};
\node [below] at (14.28,0) {\textcolor{tRed}{\small$22$}};
\node [below] at (14.92,0) {\textcolor{tRed}{\small$42$}};
\node [below] at (19.70,0) {\small$3$};
