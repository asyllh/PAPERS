\documentclass[usenames,dvipsnames,tikz,11pt]{standalone}
...
\node at (3,6.1) {\small{$R''_1$}};
\node at (7,6.1) {\small{$R''_2$}};

%\node at (5,5.3) {\small{$\mathcal{R}^* = \{R^*_1, R^*_2\}$}};

\node [right] at (3.55,5.5) {\small{$R''_1: C_1, C_2, C_3$}};
\node [right] at (3.55,5.1) {\small{$R''_2:$}};
\node [right] at (4.86,5.1) {\small{$C_2, C_3, C_4$}};
%\draw [tRed] (4.85, 5) -- (4.85, 4.9) -- (5.9, 4.9) -- (5.9, 5);
...
\draw [thick, densely dashed, tGreen2] (2,3.75) -- (3,2.75);
\draw [thick, densely dashed, tGreen2] (3,3.75) -- (4,2.75);
\draw [thick, densely dashed, tGreen2] (4,3.75) to[out=125,in=130, distance=2.2cm] (2,2.75);
...
\draw [thick, densely dashed, tGreen2] (2,0) -- (2,1);
\draw [thick, densely dashed, tGreen2] (3,0) -- (3,1);
\draw [thick, densely dashed, tGreen2] (4,0) -- (4,1);
