...
\draw [thick] (8.34,3) rectangle (10.85, 4); %251
...
\node at (9.595,3.5) {251};


\draw [thick] (-0.07,1.5) rectangle (1.96, 2.5); %202
\draw [thick] (2.26,1.5) rectangle (6.23, 2.5); %397
\draw [thick] (6.53,1.5) rectangle (9.67, 2.5); %314
\draw [thick] (9.97,1.5) rectangle (11.03, 2.5); %106
...
\draw [thick] (0,0) rectangle (3.47, 1); %347
\draw [thick] (3.97,0) rectangle (5.24, 1); %127
\draw [thick] (5.74,0) rectangle (10.96, 1); %522
...
\node at (1.735,0.5) {347};
\node at (4.605,0.5) {127};
\node at (8.35,0.5) {522};
