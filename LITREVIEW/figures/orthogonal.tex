...
\draw [thick, fill=tLightPink] (0,0) rectangle (1.81,1.81);
\draw [thick, fill=tLightOrange] (3.19,0) rectangle (5,1.81);
\draw [thick, fill=tLightYellow] (0,3.19) rectangle (1.81,5);
\draw [thick, fill=tLightGreen] (3.19,3.19) rectangle (5,5);
%\draw [thick, fill=tLightBlue] (4.5,1.5) rectangle (5.5,5);
%\filldraw[fill=tLightBlue, draw=black, semithick] (2.5,1.18) -- (1.18,2.5) -- (2.5,3.82) -- (3.82,2.5) -- (2.5,1.18);
