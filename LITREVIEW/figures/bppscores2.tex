...
\draw [dashed, tRed] (4.8,1.5) -- (4.8,2.5);
\node [below] at (0.08,1.5) {\scriptsize{$8$}};
\node [below] at (4.8,1.5) {\textcolor{tRed}{\scriptsize{$42$}}};

\draw [dashed, tRed] (5.38,1.5) -- (5.38,2.5);
\draw [dashed, tRed] (8.47,1.5) -- (8.47,2.5);
\node [below] at (5.38,1.5) {\textcolor{tRed}{\scriptsize{$16$}}};
\node [below] at (8.47,1.5) {\textcolor{tRed}{\scriptsize{$22$}}};

\draw [dashed, tRed] (8.84,1.5) -- (8.84,2.5);
\draw [dashed] (9.7,1.5) -- (9.7,2.5);
\node [below] at (8.84,1.5) {\textcolor{tRed}{\scriptsize{$15$}}};
\node [below] at (9.7,1.5) {\scriptsize{$30$}};
