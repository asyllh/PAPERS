...
\draw [thick, fill=tLightPink] (0,0) rectangle (3.5,3.5);
\draw [thick, fill=tLightOrange] (0,3.5) rectangle (3.5,5);
\draw [thick, fill=tLightYellow] (3.5,0) rectangle (5.5,1.5);
\draw [thick, fill=tLightGreen] (3.5,1.5) rectangle (4.5,5);
