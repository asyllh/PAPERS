...
\draw [thick, tRed, dashed] (6.1,0) -- (6.1,1.55); %4
\draw [thick, tRed, dashed] (6.7,0) -- (6.7,1.55); %2
...
\filldraw[fill=white, draw=black, thin] (6.675,1.75) rectangle (6.725,2.35);
...
\draw [thick, <->,>=stealth, tRed] (6.1, 2.45) -- (6.7, 2.45);
\node [above] at (6.4,2.55) {\Large{$< \tau$}};
